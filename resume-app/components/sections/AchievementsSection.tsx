...
const AchievementsSection: React.FC<Props> = ({ formData, handleChange }) => {
  ...
  const [charCount, setCharCount] = useState(formData.achievements.length);
  ...
  const achievementCount = formData.achievements
    .split('|')
  ...
  return (
    <div className="mb-8 group">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {/* Achievement counter and preview toggle */}
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
            <div className="flex items-center gap-1">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <span>{achievementCount} {achievementCount === 1 ? 'achievement' : 'achievements'}</span>
            </div>
          </div>
      ...
      <div className="relative transition-all duration-300 shadow-sm hover:shadow-md">
        <textarea
          ...
          placeholder="Enter your achievements separated by | (pipe symbol)&#10;Example: Led team of 5 developers | Increased sales by 30% | Won Employee of the Year award"
        ...
        <div className="flex items-center justify-between mt-2 px-1">
          <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
            ...
            <span>Separate each achievement with | symbol</span>
          </div>
      ...
      {/* Preview section */}
      {formData.achievements.trim() && showPreview && (
